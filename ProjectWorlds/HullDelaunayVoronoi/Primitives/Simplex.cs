...
{
    public class Simplex<VERTEX> where VERTEX : IVertex, new()
    {
        public int Dimension { get; private set; }

        /// <summary>
        /// The simplexes adjacent to this one
        /// For 2D, a simplex will be a segment and it will have 2 adjacent segemtns joining it
        /// For 3D, a simplex will be a triangle and it will have 3 adjacent triangles joining it
        /// </summary>
        ...
        /// <summary>
        /// The simplex's normal
        /// </summary>
        public float[] Normal { get; private set; }

        /// <summary>
        ///  The simplex's centroid
        /// </summary>
        public float[] Centroid { get; private set; }

        /// <summary>
        /// The simplex's offset from the origin
        /// </summary>
        ...
        public Simplex(int dimensions)
        {
            ...
            {
                throw new ArgumentException("Invalid number of dimension for Simplex", dimensions.ToString());
            }

            Dimension = dimensions;
            Adjacent = new Simplex<VERTEX>[dimensions];
            Normal = new float[dimensions];
            Centroid = new float[dimensions];
            Vertices = new VERTEX[dimensions];
        }

        public float Dot(VERTEX v)
        {
            int d = Dimension;
            if (v == null || v.Dimensions != d)
            {
                return 0.0f;
            }
