...
using ProjectWorlds.HullDelaunayVeronoi.Voronoi;

namespace ProjectWorlds.HullDelaunayVeronoi.Examples
{
    public class ExampleVoronoi3D : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                float x = size * UnityEngine.Random.Range(-1.0f, 1.0f);
                float y = size * UnityEngine.Random.Range(-1.0f, 1.0f);
                float z = size * UnityEngine.Random.Range(-1.0f, 1.0f);
        ...
        private void Update()
        {
            if (Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.KeypadMinus))
            {
