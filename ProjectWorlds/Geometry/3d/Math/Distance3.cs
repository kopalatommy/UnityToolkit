...
namespace ProjectWorlds.Geometry._3d
{
    public static class Distance3
    {
        ...
        {
            return Vector3.Distance(point, Closest3.PointLine(point, line));
        }
        ...
        {
            return Vector3.Distance(point, Closest3.PointLine(point, lineOrigin, lineDirection));
        }
        ...
        {
            return Vector3.Distance(point, Closest3.PointRay(point, ray));
        }
        ...
        {
            return Vector3.Distance(point, Closest3.PointRay(point, rayOrigin, rayDirection));
        }
        ...
        {
            return Vector3.Distance(point, Closest3.PointSegment(point, segment));
        }
        ...
        {
            return Vector3.Distance(point, Closest3.PointSegment(point, segmentA, segmentB));
        }
        ...
        public static float SegmentSphere(Vector3 segmentA, Vector3 segmentB, Vector3 sphereCenter, float sphereRadius)
        {
            ...
            if (sqrDistanceToIntersection < -Geometry3.Epsilon)
            {
                ...
                if (centerProjection > segmentLength + Geometry3.Epsilon)
                {
                    return (sphereCenter - segmentB).magnitude - sphereRadius;
                }
                return Mathf.Sqrt(sqrDistanceToLine) - sphereRadius;
