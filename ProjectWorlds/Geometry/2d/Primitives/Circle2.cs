using ProjectWorlds.Geometry._3d;
using System;
...
{
    [Serializable]
    public class Circle2 : IEquatable<Circle2>, IFormattable
    {
        ...
        {
            return Geometry2.PointOnCircle2(center, radius, angle);
        }
        ...
        {
            return Geometry2.PointsOnCircle2(center, radius, count);
        }
        ...
        {
            return Intersect2.PointCircle(point, center, radius);
        }
