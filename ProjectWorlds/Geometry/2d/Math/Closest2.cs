...
namespace ProjectWorlds.Geometry._2d
{
    public static class Closest2
    {
        ...
        {
            return PointLine(point, line.Start, line.Direction, out float projectedX);
        }
        ...
        {
            return PointLine(point, line.Start, line.Direction, out projectedX);
        }
        ...
        {
            LineLine(lineA.Start, lineA.Direction, lineB.Start, lineB.Direction, out pointA, out pointB);
        }
            ...
            out Vector2 pointA, out Vector2 pointB)
        {
            ...
            {
                // Parallel
                if (Mathf.Abs(perpDotB) > Geometry2.Epsilon ||
                    Mathf.Abs(VectorExtensions.PerpDot(directionA, originBToA)) > Geometry2.Epsilon)
                {
                    // Not collinear
                    pointA = originA;
        ...
        {
            LineRay(line.Start, line.Direction, ray.origin, ray.direction, out linePoint, out rayPoint);
        }
        ...
        {
            LineSegment(line.Start, line.Direction, segment.a, segment.b, out linePoint, out segmentPoint);
        }
        ...
        {
            LineCircle(line.Start, line.Direction, circle.center, circle.radius, out linePoint, out circlePoint);
        }
            ...
            out Vector2 segment1Point, out Vector2 segment2Point)
        {
            ...
            if (Mathf.Abs(denominator) < Geometry2.Epsilon)
            {
                ...
                if (Mathf.Abs(perpDot1) > Geometry2.Epsilon || Mathf.Abs(perpDot2) > Geometry2.Epsilon)
                {
                    ...
                    bool segment2BIsAfter1A = segment2BProjection > -Geometry2.Epsilon;
                    ...
                    bool segment2AIsBefore1B = segment2AProjection < segment1Length + Geometry2.Epsilon;
            ...
            out Vector2 segmentPoint, out Vector2 circlePoint)
        {
            ...
            if (segmentLength < Geometry2.Epsilon)
            {
                ...
                if (distanceToPoint < circleRadius + Geometry2.Epsilon)
                {
                    ...
                    if (distanceToPoint < Geometry2.Epsilon)
                    {
                        circlePoint = segmentPoint;
                        return;
                    }
