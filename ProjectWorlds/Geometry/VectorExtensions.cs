...
namespace ProjectWorlds.Geometry
{
    public static class VectorExtensions
    {
        ...
        {
            return Mathf.Abs(PerpDot(vector, other)) < Geometry2.Epsilon;
        }
        ...
        {
            return new Vector2((vector.x + vector.y) * GeometryUtils.Sqrt05, (vector.y - vector.x) * GeometryUtils.Sqrt05);
        }
