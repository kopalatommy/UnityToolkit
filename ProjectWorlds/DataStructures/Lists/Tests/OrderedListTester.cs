...
{
    public class OrderedListTester : ListTesterBase<OrderedList<int>>
    {
        public OrderedListTester() : base("Ordered List Tester")
        {
            testType = GetType();
        }
        ...
        {
            OrderedList<int> list = CreateListDefault();
        ...
        public override bool SetTest2()
        {
            ...
            for (int i = 1; i < list.Count; i++)
            {
                if (list[i] != (i - 1))
                {
                    UnityEngine.Debug.Log("SetTest2 failed @ 1");
                    return false;
                }
            }

            return list.Count == 11 && list[0] == -1;
        }
        ...
        {
            OrderedList<int> list = CreateListDefault();
            OrderedList<int> toInsert = CreateListDefault();
        ...
        public override bool TakeFirstTest3()
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                if (list[i - 1] != i)
                {
                    UnityEngine.Debug.Log("TakeFirstTest3 failed @ 1: " + list[i - 1] + " != " + i + " - " + list);
                    return false;
                }
            }
        ...
        public override bool LastIndexOfTest5()
        {
            ...
            if (list.LastIndexOf(1) != 10)
            {
                UnityEngine.Debug.Log("LastIndexOfTest5 failed: last index of 1 = " + list.LastIndexOf(1) + " != " + 10 + " - " + list + " - " + list.IndexOf(1));
            }
